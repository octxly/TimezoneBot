import { Client, Intents, PermissionResolvable, Collection, GuildApplicationCommandManager, ApplicationCommandManager, TextChannel } from "discord.js"
import fs from "fs"
...
mongoose.connect(`mongodb://localhost:27017/TimezoneBot`, () => console.log("connected to database"))
...
client.once("ready", async () => {
    ...
    let commandManager: GuildApplicationCommandManager | ApplicationCommandManager
...
client.on("interactionCreate", async interaction => {
    ...
    const permsList: PermissionResolvable = [
        "MANAGE_ROLES",
        "VIEW_CHANNEL",
        "SEND_MESSAGES",
...
const update = () => {
    setInterval(async () => {
        ...
        for await (const doc of GuildModel.find()){
